    ...
    <div className="markdown-body prose prose-sm max-w-none break-words">
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ node, ...props }) => <h2 className="text-base font-bold mt-4 mb-2" {...props} />,
          h2: ({ node, ...props }) => <h3 className="text-sm font-semibold mt-3 mb-2" {...props} />,
          h3: ({ node, ...props }) => <h4 className="text-sm font-semibold mt-3 mb-1" {...props} />,
